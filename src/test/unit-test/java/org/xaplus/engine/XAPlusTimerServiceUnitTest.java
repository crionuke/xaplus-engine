...
public class XAPlusTimerServiceUnitTest extends XAPlusUnitTest {
    static private final Logger logger = LoggerFactory.getLogger(XAPlusTimerServiceUnitTest.class);
