...
public class XAPlus2pcPreparerServiceTest extends XAPlusTest {
//    static private final Logger logger = LoggerFactory.getLogger(XAPlus2pcPreparerServiceTest.class);
//
//    XAPlus2pcPreparerService xaPlus2pcPreparerService;
//
...
//
//        xaPlus2pcPreparerService = new XAPlus2pcPreparerService(properties, threadPool, dispatcher, resources,
//                new XAPlusTracker());
//        xaPlus2pcPreparerService.postConstruct();
//
...
//        xaPlus2pcPreparerService.finish();
//        consumerStub.finish();
//    }
//
//    @Test
...
//        dispatcher.dispatch(new XAPlusRemoteSubordinateReadiedEvent(bxid3));
